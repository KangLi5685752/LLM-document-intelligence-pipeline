"""Offline default-deny CLI tests for the Stage 4D development transaction."""
...
from document_intelligence.llm_extraction import (
    openai_development_execution_cli as cli,
)
...
def test_cli_defaults_to_no_call_readiness(
    ...
    monkeypatch.setattr(
        execution, "_validate_openai_development_execution_readiness", readiness
    )
    ...
    assert capsys.readouterr().out == (
        ...
        'execution-v0.1","execution_plan_sha256":"F92DBA083F5A92E6EFFF0E7D58B9D'
        '05553934AD3689FB90A3D091BD39D9D29A7","mode":"readiness",'
        '"status":"ready"}\n'
    )
...
def test_pyproject_exposes_default_deny_development_execution_cli() -> None:
    ...
    expected = (
        ...
        'openai_development_execution_cli:main"'
    )
